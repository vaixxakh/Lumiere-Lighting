...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:relative z-40 w-72 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 h-screen flex flex-col transition-transform duration-300 shadow-2xl`}>
        {/* Logo Section */}
      ...
      <div className="flex-1 flex flex-col">
        {/* Top Header */}
        <header className="bg-gradient-to-r from-white to-gray-50 border-b border-gray-200 p-6 shadow-sm sticky top-0 z-30">
